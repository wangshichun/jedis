...
import com.github.wangshichun.jedis.internal.BinaryJedisCluster;
import com.github.wangshichun.jedis.internal.JedisClusterCommand;
...
public class JedisCluster extends BinaryJedisCluster implements JedisCommands,
    ...
    public void setReadPreference(ReadPreference readPreference) {
        connectionHandler.setReadPreference(readPreference);
    }

    public void setSlaveSelect(ISlaveSelect select) {
        connectionHandler.setSlaveSelect(select);
    }
    ...
    public Long sdiffstore(final String dstkey, final String... keys) {
        ...
        }.run(false, mergedKeys.length, mergedKeys);
    }
    ...
    public Long sunionstore(final String dstkey, final String... keys) {
        ...
        }.run(false, wholeKeys.length, wholeKeys);
    }
    ...
    public String brpoplpush(final String source, final String destination, final int timeout) {
        ...
        }.run(false, 2, source, destination);
    }
    ...
    public Object eval(final String script, final List<String> keys, final List<String> args) {
        ...
        }.run(false, keys.size(), keys.toArray(new String[keys.size()]));
    }
